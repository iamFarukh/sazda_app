/**
 * Start of each Juz in the Uthmani mushaf (surah : ayah).
 * Used to open the correct place when user picks a Juz (no heavy full-juz fetch).
 */
export const JUZ_START: readonly { juz: number; surah: number; ayah: number }[] = [
  { juz: 1, surah: 1, ayah: 1 },
  { juz: 2, surah: 2, ayah: 142 },
  { juz: 3, surah: 2, ayah: 252 },
  { juz: 4, surah: 3, ayah: 92 },
  { juz: 5, surah: 4, ayah: 23 },
